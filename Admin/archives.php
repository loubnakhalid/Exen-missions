        ...
        <div class="card-header">
            ...
            <div class="entete">
                <div class="search-add">
                    <form class="d-flex" style="margin-right: 14px;">
                        <input class="form-control me-sm-2 inptSearch" type="search" id="searchInput" placeholder="Rechercher" style="margin-right: -55px!important">
                        <button class="btn btn-secondary my-2 my-sm-0 subSearch" type="submit" style="margin-top: 5px !important;"><i class="fa-solid fa-magnifying-glass" aria-hidden="true"></i></button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="table table-responsive" >
                <table cellspacing='0' id="tableMission">
                    ...
                    <tr>
                        ...
                        <th>Nuité</th>
                        <th>Date mission</th>
                        <th><i class="fa-solid fa-gear" style="color: #5a5a5a;"></i></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
